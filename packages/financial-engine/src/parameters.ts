...
export const BESTANDSRENDITE_PARAMETERS = {
  ...
  leerstandMoebliertPercent: describe({
    ...
    label: "Leerstand (möbliert)",
    description:
      "Höherer Mietausfall bei möblierter Vermietung — gilt für alle drei möblierten Dauer-Varianten (Langzeit/Mittelzeit/Kurzzeit ausserhalb der Short-Stay-Auslastungslogik). Rückmeldung nennt eine Spanne von 5–8%.",
    unit: "%",
    defaultValue: 6,
    source: "Möblierte Vermietungen haben empirisch höhere Leerstände als unmöblierte Langzeitvermietung — 6% als Mittelwert der genannten 5–8%-Spanne.",
  }),
  moeblierungNutzungsdauerJahre: describe({
    key: "moeblierungNutzungsdauerJahre",
    label: "Möblierungs-Nutzungsdauer (Möbel)",
    description: "Nach dieser Anzahl Jahre wird im Mehrjahresmodell ein Möbelersatz als konkreter Cash-Abfluss angesetzt (100% der inflationierten Initialkosten, siehe SIPIS Furnished-Rental-Modul v1.1 — kein Teil-Wiederverwendungsabzug mehr).",
    unit: "Jahre",
    defaultValue: 8,
    source: "Vorgabe der SIPIS-Fachspezifikation v1.1 (furniture_useful_life_years = 8) — vom Auftraggeber direkt geliefert, keine eigene Recherche nötig.",
  }),
  haushaltinventarNutzungsdauerJahre: describe({
    key: "haushaltinventarNutzungsdauerJahre",
    label: "Haushaltsinventar-Nutzungsdauer",
    description: "Analog zu moeblierungNutzungsdauerJahre, aber für das separat erfasste Haushaltsinventar (Geschirr, Kleingeräte, Textilien) — typischerweise kürzere Nutzungsdauer als die eigentliche Möblierung.",
    unit: "Jahre",
    defaultValue: 5,
    source: "Vorgabe der SIPIS-Fachspezifikation v1.1 (household_inventory_useful_life_years = 5).",
  }),
  minimumRequiredFurnitureRoiPercent: describe({
    key: "minimumRequiredFurnitureRoiPercent",
    label: "Mindestrendite Möblierungsinvestition",
    description: "Geforderte Mindestrendite auf die Möblierungs-/Haushaltsinventar-Investition, oberhalb der reinen Kostendeckung — Grundlage für den 'wirtschaftlich sinnvollen Mindest-Mietaufschlag' (minimum_economic_furnishing_premium).",
    unit: "%",
    defaultValue: 15,
    source: "Vorgabe der SIPIS-Fachspezifikation v1.1 (minimum_required_furniture_ROI = 0.15) — vom Auftraggeber direkt geliefert.",
  }),
