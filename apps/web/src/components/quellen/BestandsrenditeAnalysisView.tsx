...
import type { BestandsrenditeAnalysisResult } from "@/lib/bestandsrenditeVertiefung";

/**
 * Reine Anzeige der drei Ebenen (docs/OPEN_DECISIONS.md, Punkt N) — die Berechnung
 * selbst (`computeBestandsrenditeAnalysis`) ist eine reine Funktion ohne
 * Suchprofil-/Annahmen-Register-Abhängigkeit (anders als die Bauland-Objekt-Analyse),
 * läuft deshalb serverseitig in der Detailseite, kein Client-Live-Recompute nötig.
 */
