...
import type { BestandsrenditeFacts } from "@/lib/bestandsrenditeVertiefung";
 ...
 */
export function BestandsrenditeVertiefungForm({ listingId, existing }: { listingId: string; existing: BestandsrenditeFacts | null }) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch(`/api/listings/${listingId}/bestandsrendite`, {
        method: "POST",
